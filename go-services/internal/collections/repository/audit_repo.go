...
// AuditRecord is a row from the collections-service audit_log table.
...
// AuditRepository provides data access for the collections audit_log table.
...
func (r *AuditRepository) InsertAuditLog(ctx context.Context, e *audit.Entry) error {
...
func (r *AuditRepository) ListAuditLog(ctx context.Context, tenantID, entityType, entityID string, limit, offset int) ([]*AuditRecord, error) {
...
func (r *AuditRepository) VerifyAuditChain(ctx context.Context, tenantID string) (*ChainVerification, error) {
	v := &ChainVerification{}
