...
// AuditRecord is a row from the shared loans audit_log table.
...
// VerifyAuditChain walks the hash chain for the tenant and reports whether the
// loans audit_log is intact or the seq of the first tampered/missing entry.
