...
2. **eKYC vendor** (A2) — ✅ **decided: in-house first** (ekyc-ml-service engine shipped, `nemo/a2-inhouse-ekyc`); commercial vendors (Smile ID / Veriff class) remain a pluggable per-client secondary option via the provider registry.
